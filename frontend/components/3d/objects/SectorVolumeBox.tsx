  ...
  return (
    <group position={center}>
      ...
      <Html position={[0, size[1] / 2 + 2, 0]} center>
        <div className="whitespace-nowrap rounded border border-black bg-paper/90 px-2 py-1 font-mono text-[10px] tracking-wider text-black shadow-md backdrop-blur-sm">
